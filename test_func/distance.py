...
def write_results(future, csv_file):
...
#                logger.info(id_1)
    ...
    #                    logger.info(id_1)
                        ...
                        if process_sub >= total:
                            break
                        elif id_1['EnterpriseID'] >= id_2['EnterpriseID']:
                            continue
                        else:
                            try:
                                future_ = executor.submit(output_calculation, id_1 = str(id_1['EnterpriseID']), id_2 = str(id_2['EnterpriseID']),
                                                            id_1_column1_name = id_1[column1_name], id_2_column1_name = id_2[column1_name],
                                                            id_1_column2_name = id_1[column2_name], id_2_column2_name = id_2[column2_name])
                                future_.add_done_callback(functools.partial(write_results, csv_file = csv_file))
